    ...
    public int solve(int[][] A, int B) {
        ...
        while(i < N && j >=0){
            ...
            if(A[i][j] == B){
                ...
                // the same element could be there in the bottom also in left,
                // As we are going to get the minimum value i shouldn't increase that means we should not go down
                // we should go left
